...
export default function Home() {
  ...
  return (
    <>
        ...
        <section className="grid lg:grid-cols-2 content-center min-h-screen">
          <div className="flex flex-col justify-center">
            <div className="min-h-[60vh] flex flex-col gap-4 justify-center text-center lg:text-start z-10">
              ...
              <div className="flex gap-4 justify-center font-semibold text-green-600">
                <p>7th Edition</p>
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro maiores doloremque quas. Aperiam, incidunt nobis?</p>
      ...
      <section className={`flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-8 ${EVENT ? "min-h-[60vh]" : "min-h-screen"}`}>
      ...
      <section className="relative w-full min-h-[60vh] flex flex-col gap-4 justify-center items-center">
        ...
        <h2 className={subtitle({ className: "font-bold" })}>Par les jeunes <br /> Pour les jeunes</h2>
        <div className="w-full flex flex-col lg:flex-row gap-8 justify-center items-center">
          <div className="w-full lg:w-1/4 bg-white shadow-lg dark:bg-green-950 rounded-lg p-4 flex flex-col gap-4 items-center">
            <i>ICON</i>
            <h2>SUBTITLE</h2>
            <p>DESC</p>
          </div>
            ...
            <div className="lg:col-span-4">
              <blockquote>
                <div className="relative text-xl font-medium text-gray-800 lg:text-2xl lg:leading-normal dark:text-neutral-200">
                  <svg className="absolute top-0 start-0 transform -translate-x-4 -translate-y-12 size-24 text-gray-200 dark:text-neutral-700 z-0" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  ...
                  <p className="relative z-10">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto, odio excepturi. Error aliquam ipsum nulla officiis non voluptates voluptas laboriosam illo facilis, quae in cum earum, amet eum aliquid recusandae.
                  </p>
                </div>
